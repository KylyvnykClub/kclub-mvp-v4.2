...
This project is indexed by GitNexus as **kclub-mvp-v4.2** (1165 symbols, 2198 relationships, 85 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
